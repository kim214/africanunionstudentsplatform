      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <button
                  ...
                  className="text-left text-sm text-primary-foreground/60 hover:text-primary-foreground transition-colors py-1"
                >
                  {link.label}
                </button>
              ))}
          ...
          <div>
            ...
            <button className="px-6 py-3 rounded-lg bg-gold-gradient text-foreground font-semibold text-sm shadow-gold hover:opacity-90 transition-opacity">
              Join AUSP Today
            </button>
          </div>
        </div>
