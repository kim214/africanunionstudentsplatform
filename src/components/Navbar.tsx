...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top Contact Bar */}
      <div className={`fixed top-0 left-0 right-0 z-[60] transition-all duration-300 ${showTransparent ? "bg-foreground/30 backdrop-blur-sm" : "bg-foreground"}`}>
        <div className="container mx-auto flex items-center justify-between px-4 py-1.5 text-xs text-primary-foreground">
          <div className="flex items-center gap-4">
            <a href="mailto:info@ausp.org" className="inline-flex items-center gap-1.5 hover:text-secondary transition-colors">
              <Mail className="w-3 h-3" /> info@ausp.org
            </a>
            <a href="tel:+254000000000" className="hidden sm:inline-flex items-center gap-1.5 hover:text-secondary transition-colors">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#" className="hover:text-secondary transition-colors"><Linkedin className="w-3.5 h-3.5" /></a>
